# WPS Office Ubuntu: Русификация и установка необходимых шрифтов и проверка орфографии русского языка
...
sudo mv /opt/kingsoft/wps-office/office6/mui/ru_RU/ /opt/kingsoft/wps-office/office6/mui/en_US/ 
```
